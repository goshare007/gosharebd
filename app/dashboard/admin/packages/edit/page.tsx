...
function EditPackageForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      couplePrice: pkg.couplePrice ? Number(pkg.couplePrice) : undefined,
      ...
      ageRestriction: pkg.ageRestriction ?? '',
      ...
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        <div className='mb-8'>
          <Button variant='ghost' size='sm' className='mb-4' asChild>
            <Link
              href={`/dashboard/admin/destinations/${pkg.destinationId}`}
              className='gap-2'
            >
          ...
          <div className='grid gap-6'>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Primary image shown on package cards. Upload a new one to
